...
<View style={{ flexDirection: isRtl ? ‘row-reverse’ : ‘row’, alignItems: ‘center’, flexShrink: 1 }}>
...
```
  ...
  >
    ...
    {/* Language */}
    <View style={{ flexDirection: isRtl ? 'row-reverse' : 'row', alignItems: 'center', marginTop: 18, marginBottom: 6, marginLeft: isRtl ? 0 : 4, marginRight: isRtl ? 4 : 0 }}>
